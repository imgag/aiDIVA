...
if __name__=="__main__":
    ...
    parser.add_argument("--output_table", dest="output_table", action="store_true", required=False, help="Flag to indicate that we want to save the annotation additionally as a TSV file")
